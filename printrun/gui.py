...
class MainToolbar(wx.BoxSizer):
    ...
    def __init__(self, root):
        ...
        root.testprintbtn = make_autosize_button(root.panel, _("Print a test"), root.testprint, _("Print a test object to check the proper working of the 3d printer hardware"), self)
